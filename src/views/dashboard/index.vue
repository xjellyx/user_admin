      ...
      let  option = {
          ...
          dataset: {
              source: [
                  ...
                  ['Apple', 41.1, 30.4, 65.1, 53.3, 83.8, 70.0,6.4, 65.2, 82.5],
                  ['ASUS', 86.5, 92.1, 85.7, 83.1, 73.4, 55.1,2, 67.1, 69.2],
                  ['HP', 24.1, 67.2, 79.5, 86.4, 65.2, 82.5,65.1, 53.3, 83.8],
                  ['Lenovo', 55.2, 67.1, 69.2, 72.4, 53.9, 39.1,86.5, 92.1, 85.7],
                  ['Microsoft', 55.2, 67.1, 69.2, 72.4, 53.9, 39.1,86.5, 92.1, 85.7]
              ]
          },
          xAxis: {
              type: 'category',
